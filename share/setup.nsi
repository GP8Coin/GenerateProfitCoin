...
Section -post SEC0001
    ...
    #    WriteRegStr HKCR "bitcoin" "" "URL:GenerateProfitCoin"
    #    WriteRegStr HKCR "bitcoin\DefaultIcon" "" $INSTDIR\bitcoin-qt.exe
    #    WriteRegStr HKCR "bitcoin\GenerateProfitCoin\open\command" "" '"$INSTDIR\bitcoin-qt.exe" "$$1"'
SectionEnd
...
Section -un.post UNSEC0001
    ...
    #Delete /REBOOTOK "$SMPROGRAMS\$StartMenuGroup\GenerateProfitCoin.lnk"
    #Delete /REBOOTOK "$SMSTARTUP\GenerateProfitCoin.lnk"
