...
extern GenerateProfitCoinGUI* guiref;
...
/**
  GenerateProfitCoin GUI main class. This class represents the main window of the GenerateProfitCoin UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class GenerateProfitCoinGUI : public QMainWindow
{
    Q_OBJECT

public:
    explicit GenerateProfitCoinGUI(QWidget *parent = 0);
    ~GenerateProfitCoinGUI();
    ...
    */
    ...
    /** Set the message model.
        The message model represents a GenerateProfitCoin  Note or D-Note, and offers secure messaging through a peer to peer
        relay.
    */
...
private slots:
    ...
    */
    ...
    /** Edit the GenerateProfitCoin.conf file */
    void editConfig();
    void editConfigExt();
