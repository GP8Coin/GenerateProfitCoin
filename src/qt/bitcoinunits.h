...
/** GenerateProfitCoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class GenerateProfitCoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit GenerateProfitCoinUnits(QObject *parent);

    /** GenerateProfitCoin units.
...
typedef GenerateProfitCoinUnits::Unit GenerateProfitCoinUnit;
