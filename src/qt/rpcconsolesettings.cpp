...
/**
 * Split GenerateProfitCoin command line into a list of arguments. Aims to emulate \c bash and friends.
 *
...
void RPCConsolesettings::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the GenerateProfitCoin RPC console.") + "<br>" +
