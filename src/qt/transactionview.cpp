...
void TransactionView::changedAmount(const QString &amount)
{
    ...
    // Replace "," by "." so GenerateProfitCoinUnits::parse will not fail for users entering "," as decimal separator
    QString newAmount = amount;
    newAmount.replace(QString(","), QString("."));

    if(GenerateProfitCoinUnits::parse(model->getOptionsModel()->getDisplayUnit(), newAmount, &amount_parsed))
    {
...
void TransactionView::exportClicked()
{
    ...
    writer.addColumn(GenerateProfitCoinUnits::getAmountColumnTitle(model->getOptionsModel()->getDisplayUnit()), 0, TransactionTableModel::FormattedAmountRole);
...
void TransactionView::computeSum()
{
    ...
    QString strAmount(GenerateProfitCoinUnits::formatWithUnit(nDisplayUnit, amount, true, GenerateProfitCoinUnits::separatorAlways));
