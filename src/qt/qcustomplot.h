...
class QCP_LIB_DECL QCPAxis : public QCPLayerable
{
  ...
  Q_PROPERTY(bool rangeGenerateProfitCoinersed READ rangeGenerateProfitCoinersed WRITE setRangeGenerateProfitCoinersed)
...
public:
  ...
  */
  ...
  bool rangeGenerateProfitCoinersed() const { return mRangeGenerateProfitCoinersed; }
  ...
  void setRangeGenerateProfitCoinersed(bool reversed);
...
protected:
  ...
  // scale and range:
  QCPRange mRange;
  bool mRangeGenerateProfitCoinersed;
