...
{
    columns << QString() <<  QString() << tr("Date") << tr("Type") << tr("Address") << GenerateProfitCoinUnits::getAmountColumnTitle(walletModel->getOptionsModel()->getDisplayUnit());
...
{
	columns[Amount] = GenerateProfitCoinUnits::getAmountColumnTitle(walletModel->getOptionsModel()->getDisplayUnit());
...
{
    QString str = GenerateProfitCoinUnits::format(walletModel->getOptionsModel()->getDisplayUnit(), wtx->credit + wtx->debit);
    if(showUnconfirmed)
    {
