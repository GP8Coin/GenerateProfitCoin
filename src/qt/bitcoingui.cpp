 ...
 * The GenerateProfitCoin Developers 2018-2020
 */
...
GenerateProfitCoinGUI::GenerateProfitCoinGUI(QWidget *parent):
    QMainWindow(parent),
    clientModel(0),
    walletModel(0),
    toolbar(0),
    ...
    nWeight(0)
{
    ...
    setWindowTitle(tr("GenerateProfitCoin") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
    ...
    setObjectName("GenerateProfitCoin");
    setStyleSheet("#GenerateProfitCoin { background-image: url(:/images/background_light); }");//background-color: #e6e6e6; color: #333333;
...
GenerateProfitCoinGUI::~GenerateProfitCoinGUI()
{
...
void GenerateProfitCoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a GenerateProfitCoin address"));
    ...
    aboutAction = new QAction(QIcon(fUseDarkTheme ? ":/icons/dark/bitcoin-dark" : ":/icons/bitcoin"), tr("&About GenerateProfitCoin"), this);
    aboutAction->setToolTip(tr("Show information about GenerateProfitCoin"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/qt-project.org/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for GenerateProfitCoin"));
    ...
    editConfigAction = new QAction(QIcon(":/icons/editconf"), tr("&Edit GenerateProfitCoin.conf"), this);
    editConfigAction->setToolTip(tr("Edit the configuration file for GenerateProfitCoin"));
    editConfigExtAction = new QAction(QIcon(":/icons/editconf"), tr("&Edit GenerateProfitCoin.conf (external)"), this);
    editConfigExtAction->setToolTip(tr("Edit the configuration file for GenerateProfitCoin (external editor)"));
    openDataDirAction = new QAction(QIcon(":/icons/folder"), tr("&Open data dir"), this);
    openDataDirAction->setToolTip(tr("Open the directory where GenerateProfitCoin data is stored"));
...
//void GenerateProfitCoinGUI::createMenuBar()
//{
//#ifdef Q_OS_MAC
...
void GenerateProfitCoinGUI::createToolBars()
{
...
void GenerateProfitCoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("GenerateProfitCoin client") + QString(" ") + tr("[testnet]"));
...
void GenerateProfitCoinGUI::setWalletModel(WalletModel *walletModel)
{
...
void GenerateProfitCoinGUI::setMessageModel(MessageModel *messageModel)
{
...
void GenerateProfitCoinGUI::createTrayIcon()
{
    QMenu *trayIconMenu;
#ifndef Q_OS_MAC
    ...
    trayIcon->setToolTip(tr("GenerateProfitCoin client"));
...
#ifndef Q_OS_MAC
void GenerateProfitCoinGUI::trayIconActivated(QSystemTrayIcon::ActivationReason reason)
{
...
void GenerateProfitCoinGUI::optionsClicked()
{
...
void GenerateProfitCoinGUI::aboutClicked()
{
    AboutDialog dlg;
...
void GenerateProfitCoinGUI::aboutQtExt_Internal()
{
    aboutQtAction->triggered();
}

void GenerateProfitCoinGUI::aboutQtExt_Static()
{
    guiref->aboutQtExt_Internal();
}

void GenerateProfitCoinGUI::setNumConnections(int count)
{
    QString icon;
    switch(count)
    {
    ...
    //labelConnectionsIcon->setToolTip(tr("%n active connection(s) to GenerateProfitCoin network", "", count));
}

void GenerateProfitCoinGUI::setNumBlocks(int count)
{
    QString tooltip;
...
void GenerateProfitCoinGUI::message(const QString &title, const QString &message, bool modal, unsigned int style)
{
    QString strTitle = tr("GenerateProfitCoin") + " - ";
...
void GenerateProfitCoinGUI::error(const QString &title, const QString &message, bool modal)
{
...
void GenerateProfitCoinGUI::changeEvent(QEvent *e)
{
...
void GenerateProfitCoinGUI::closeEvent(QCloseEvent *event)
{
    if(clientModel)
    {
#ifndef Q_OS_MAC // Ignored on Mac
...
void GenerateProfitCoinGUI::askFee(qint64 nFeeRequired, bool *payFee)
{
    if (!clientModel || !clientModel->getOptionsModel())
        return;
    ...
    QString strMessage = tr("This transaction is over the size limit. You can still send it for a fee of %1, "
        ...
        "Do you want to pay the fee?").arg(GenerateProfitCoinUnits::formatWithUnit(clientModel->getOptionsModel()->getDisplayUnit(), nFeeRequired));
...
void GenerateProfitCoinGUI::incomingTransaction(const QModelIndex & parent, int start, int end)
{
    ...
    notificator->notify(Notificator::Information,
                        (amount)<0 ? tr("Sent transaction") :
                          ...
                          tr("Date: %1\n"
                             ...
                             "Address: %4\n")
                          .arg(date)
                          .arg(GenerateProfitCoinUnits::formatWithUnit(walletModel->getOptionsModel()->getDisplayUnit(), amount, true))
                          .arg(type)
                          .arg(address), icon);
}

void GenerateProfitCoinGUI::incomingMessage(const QModelIndex & parent, int start, int end)
{
    if(!messageModel)
        return;
...
void GenerateProfitCoinGUI::clearWidgets()
{
...
void GenerateProfitCoinGUI::gotoMasternodeManagerPage()
{
    ...
    setStyleSheet("#GenerateProfitCoin { background-image: url(:/images/background_light_alt); }");
}

void GenerateProfitCoinGUI::gotoBlockBrowser()
{
...
void GenerateProfitCoinGUI::gotoOverviewPage()
{
    ...
    setStyleSheet("#GenerateProfitCoin { background-image: url(:/images/background_light); }");
}

void GenerateProfitCoinGUI::gotoHistoryPage()
{
...
void GenerateProfitCoinGUI::gotoHistoryPage_static()
{
    guiref->gotoHistoryPage();
}

void GenerateProfitCoinGUI::gotoAddressBookPage()
{
...
void GenerateProfitCoinGUI::gotoReceiveCoinsPage()
{
...
void GenerateProfitCoinGUI::gotoSendCoinsPage()
{
...
void GenerateProfitCoinGUI::gotoSignMessageTab(QString addr)
{
...
void GenerateProfitCoinGUI::gotoVerifyMessageTab(QString addr)
{
...
void GenerateProfitCoinGUI::gotoMessagePage()
{
...
void GenerateProfitCoinGUI::gotoSettingsPage()
{
...
void GenerateProfitCoinGUI::dragEnterEvent(QDragEnterEvent *event)
{
    // Accept only URIs
...
void GenerateProfitCoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid GenerateProfitCoin address or malformed URI parameters."));
    }

    event->acceptProposedAction();
}

void GenerateProfitCoinGUI::handleURI(QString strURI)
{
    // URI has to be valid
...
void GenerateProfitCoinGUI::setWalletUnlockStakingOnly()
{
...
void GenerateProfitCoinGUI::setUnencrypted()
{
    changePassphraseAction->setEnabled(false);
...
void GenerateProfitCoinGUI::setUnlocked()
{
...
void GenerateProfitCoinGUI::setLocked()
{
    changePassphraseAction->setEnabled(true);
    unlockWalletAction->setVisible(true);
    lockWalletAction->setVisible(false);
...
void GenerateProfitCoinGUI::setEncryptionStatus(int status)
{
...
void GenerateProfitCoinGUI::encryptWallet()
{
    if(!walletModel)
        return;
...
void GenerateProfitCoinGUI::backupWallet()
{
...
void GenerateProfitCoinGUI::importPrivateKey()
{
...
void GenerateProfitCoinGUI::changePassphrase()
{
...
void GenerateProfitCoinGUI::unlockWallet()
{
    if(!walletModel)
        return;
...
void GenerateProfitCoinGUI::lockWallet()
{
    if(!walletModel)
        return;
...
void GenerateProfitCoinGUI::showNormalIfMinimized(bool fToggleHidden)
{
...
void GenerateProfitCoinGUI::toggleHidden()
{
    showNormalIfMinimized(true);
}

void GenerateProfitCoinGUI::updateWeight()
{
    if (!pwalletMain)
        return;
...
/*void GenerateProfitCoinGUI::updateStakingIcon()
{
    updateWeight();
...
void GenerateProfitCoinGUI::detectShutdown()
{
    if (ShutdownRequested())
        QMetaObject::invokeMethod(QCoreApplication::instance(), "quit", Qt::QueuedConnection);
}

/*void GenerateProfitCoinGUI::showProgress(const QString &title, int nProgress)
{
    if (nProgress == 0)
    {
...
void GenerateProfitCoinGUI::editConfig()
{
...
void GenerateProfitCoinGUI::editConfigExt()
{
...
void GenerateProfitCoinGUI::openDataDir()
{
