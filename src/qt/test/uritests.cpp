...
void URITests::uriTests()
{
    ...
    QVERIFY(!GUIUtil::parseGenerateProfitCoinURI(uri, &rv));
    ...
    QVERIFY(GUIUtil::parseGenerateProfitCoinURI("bitcoin://175tWpb8K1S7NmH4Zx6rewF9WQrcZv245W?message=Wikipedia Example Address", &rv));
    QVERIFY(rv.address == QString("175tWpb8K1S7NmH4Zx6rewF9WQrcZv245W"));
    QVERIFY(rv.label == QString());
