...
Value pubkeyaliasservice(const Array& params, bool fHelp)
{
    ...
    if (fHelp  ||
        ...
        throw runtime_error(
                ...
                "  start        - Start pubkeyaliasservice configured in GenerateProfitCoin.conf\n"
                ...
                "  stop         - Stop pubkeyaliasservice configured in GenerateProfitCoin.conf\n"
    ...
    if(strCommand == "status")
    {
        ...
        if (ppas) mnObj.push_back(Pair("pubkey", CGenerateProfitCoinAddress(ppas->pubkey.GetID()).ToString()));
