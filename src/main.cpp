...
const string strMessageMagic = "GenerateProfitCoin Signed Message:\n";
                               ...
                               bool fBlock, bool fMiner, MapPrevTx& inputsRet, bool& fInvalid) const
{
    ...
    for (unsigned int i = 0; i < vin.size(); i++)
    {
        ...
        {
            // GenerateProfitCoinisit this if/when transaction replacement is implemented and allows
            // adding inputs:
            fInvalid = true;
...
bool CBlock::CheckBlock(bool fCheckPOW, bool fCheckMerkleRoot, bool fCheckSig) const
{
    ...
    if(nBestHeight > 110 && (nMasterNodeChecksDelayBaseTime + nMasterNodeDelay) < GetTime())
    {
...
{
    RenameThread("GenerateProfitCoin-loadblk");
