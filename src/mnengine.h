...
class CGenerateProfitCoinAddress;
...
{
public:
    /// Is the inputs associated with this public key? (and there is 250000/1000000 GP8 - checking if valid masternode)
    bool IsVinAssociatedWithPubkey(CTxIn& vin, CPubKey& pubkey);
    /// Is the inputs associated with this public key? (and there is 1000000 GP8 - checking if valid masternode)
