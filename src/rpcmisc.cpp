...
Value validateaddress(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "validateaddress <GenerateProfitCoin>\n"
            "Return information about <GenerateProfitCoin>.");
...
Value validatepubkey(const Array& params, bool fHelp)
{
    if (fHelp || !params.size() || params.size() > 2)
        throw runtime_error(
            "validatepubkey <GenerateProfitCoinpubkey>\n"
            "Return information about <GenerateProfitCoinpubkey>.");
...
Value verifymessage(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 3)
        throw runtime_error(
            "verifymessage <GenerateProfitCoin> <signature> <message>\n"
