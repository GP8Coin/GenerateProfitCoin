...
//
// Bootup the masternode, look for a 2,000,000 GP8 input and register on the network
//
void CActiveMasternode::ManageStatus()
{
    ...
    if(status == MASTERNODE_NOT_PROCESSED) {
        ...
        if(GetMasterNodeVin(vin, pubKeyCollateralAddress, keyCollateralAddress)) {
            ...
            /* donations are not supported in GenerateProfitCoin.conf */
...
{
    CGenerateProfitCoinAddress address(collateralAddress);
