...
extern int nAnonymizeGenerateProfitCoinAmount;
...
inline uint32_t ByteGenerateProfitCoinerse(uint32_t value)
{
...
{
    std::string s = strprintf("GenerateProfitCoin-%s", name);
