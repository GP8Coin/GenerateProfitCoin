    ...
    if(fMasterNode) {
        ...
        BOOST_FOREACH(const CTransaction& txCollateral, vecSessionCollateral) {
            ...
            /*
                ...
                allow endless transaction that would bloat GenerateProfitCoin and make it unusable. To
                stop these kinds of attacks 1 in 50 successful transactions are charged. This
                adds up to a cost of 0.002 GP8 per transaction on average.
            */
            if(r <= 10)
            {
...
void ThreadCheckMNenginePool()
{
    ...
    RenameThread("GenerateProfitCoin-mnengine");
